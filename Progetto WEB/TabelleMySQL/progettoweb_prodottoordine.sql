...
CREATE TABLE `prodottoordine` (
  ...
  KEY `ordine` (`ordine`),
  CONSTRAINT `prodottoordine_ibfk_1` FOREIGN KEY (`prodotto`) REFERENCES `prodotto` (`codice`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `prodottoordine_ibfk_2` FOREIGN KEY (`ordine`) REFERENCES `ordine` (`codice`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `prodottoordine` VALUES ('01','I0000860','01',10,'Recensione');
