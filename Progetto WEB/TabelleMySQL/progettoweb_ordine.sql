...
CREATE TABLE `ordine` (
  ...
  PRIMARY KEY (`codice`),
  KEY `utente` (`utente`),
  CONSTRAINT `ordine_ibfk_1` FOREIGN KEY (`utente`) REFERENCES `utente` (`login`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `ordine` VALUES ('01','utente',10,'2017-06-06');
